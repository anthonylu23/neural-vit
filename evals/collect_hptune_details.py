...
def _resolve_experiment(experiment: Optional[str]) -> str:
    return experiment or os.environ.get("AIP_EXPERIMENT_NAME") or "lfp-temporal-vit-hptune"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Collect HP tuning metrics from GCS and attach experiment parameters."
    )
    parser.add_argument(
        "--metrics-root",
